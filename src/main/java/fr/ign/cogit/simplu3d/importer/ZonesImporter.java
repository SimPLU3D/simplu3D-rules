...
public class ZonesImporter {
	...
	public static String NOM_ATT_LIBELLE = "LIBELLE";
	public static String NOM_ATT_LIBELONG = "LIBELONG";
	public static String NOM_ATT_TYPE_ZONE = "TYPEZONE";
	public static String NOM_ATT_DESTDOMI = "DESTDOMI";
	public static String NOM_ATT_NOMFIC = "NOMFIC";
	public static String NOM_ATT_URLFIC = "URLFIC";
	public static String NOM_ATT_INSEE = "INSEE";
	public static String NOM_VALIDITY_DATE_APPRO = "DATAPPRO";
	public static String NOM_VALIDITY_DATE_VALID = "DATVALID";
	public static String NOM_ATT_TEXT = "TEXT";

	public static IFeatureCollection<UrbaZone> importUrbaZone(IFeatureCollection<IFeature> zoneColl) {
		...
		for (IFeature feat : zoneColl) {
			...
			SimpleDateFormat sdfdeb = new SimpleDateFormat(ParametersInstructionPG.DATE_FORMAT_ZU);
			if (o != null) {
				try {
