...
public class LauncherStrasbourg {
	...
	public static void main(String[] args) throws Exception {
		...
		fenPrincipale.getMainMenuBar().add((new LauncherStrasbourg()).generateCombobox());
	...
	public static void afficheMap(int idVersion) throws Exception {
		...
		ParametersInstructionPG.database = "strasbourg_simplu";
	...
	private JComboBox<Version> generateCombobox() {
		...
		comb.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// J'ai l'ID de la version à sélectionner, maintenant, il faut
				// lancer le
				// chargement
				try {
