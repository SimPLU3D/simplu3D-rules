...
public class ParametersInstructionPG {
  ...
  public final static String ATT_ROOFING_ROOF = "roofi_id_roof";
  ...
  public final static String ATT_GUTTER_ROOF = "gut_id_roof";
  ...
  public final static String ATT_GABLE_ROOF = "gab_id_roof";
