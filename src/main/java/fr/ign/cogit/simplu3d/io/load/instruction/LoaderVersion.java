...
public class LoaderVersion {
	...
	public static void main(String[] args) throws Exception {
		...
		String gh = createWhereClauseVersion(host, port, database, user, pw, idVersion);
		...
		// TODO : ajouter condition pour verifier que l'idVersion est bien dans
		// les
		// liste obtenues
		 ...
		 * 
		 * // Correction of the collection of BPU contained in the database for
		 * our // needs IFeatureCollection<BasicPropertyUnit> collBPU =
		 ...
		 * IFeatureCollection<Building> buildColl =
		 * BuildingImporter.importBuilding( batiColl, collBPU);
		 * 
		 ...
		 * searchForBuildingPartsToBeDeleted(pointColl, env, host, port,
		 * database, user, pw);
		 */
	}
