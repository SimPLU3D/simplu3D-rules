...
public class Executor {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      PLU plu = Chargement.chargementFichier(Executor.DATA_REPOSITORY + "regles/"
          + fichier_regle);
      // On initialise l'environnement (Chargement d'objets et relations
      // entre eux)
      Environnement env = new Environnement(Executor.DATA_REPOSITORY,
          Executor.VERBOSE);
   ...
   //   new IOToolBar(fen);
      ...
      feat.setRepresentation(new TexturedSurface(feat, TextureManager
          .textureLoading(DATA_REPOSITORY + "TextParcelle.png"),
          longueur, largeur));
